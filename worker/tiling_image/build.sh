...
# Clean up old builds
rm -rf ../../devops/modules/compute/lambda/build/tiling_lambda.zip
...
mkdir -p ../../devops/modules/compute/lambda/build/tiling_lambda

# Copy build artifacts from container
CONTAINER_ID=$(docker create tiling-lambda-builder)
docker cp $CONTAINER_ID:/var/task/dist ../../devops/modules/compute/lambda/build/tiling_lambda
docker rm $CONTAINER_ID

# Zip it
cd ../../devops/modules/compute/lambda/build/tiling_lambda/dist/
